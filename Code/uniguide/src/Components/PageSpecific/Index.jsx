...
export default function Index() {
    ...
    useEffect(() => {
        window.addEventListener('touchend', handlePullToRefresh);
        return () => window.removeEventListener('touchend', handlePullToRefresh);
    }, []);
    ...
    return (
        <div className="relative">  {/* Add this wrapper */}
            ...
            {isAuthModalOpen && !isLoggedIn && (
                <div className="fixed inset-0 z-[9999] overflow-y-auto touch-none">
